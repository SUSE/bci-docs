...
=== How to build a distroless image from SLE BCI

{{< hint type="warning" >}}
The approach described in this section is unsupported and can lead to a broken
...
At a minimum, compiled applications are usually dynamically linked to libc. It is
